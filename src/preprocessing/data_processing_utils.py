...
def get_reference_bytecode():
    ...
    reference_bytecode = {
        'gnosis_multisig': w3.eth.getCode('0xDaB5dc22350f9a6Aff03Cf3D9341aAD0ba42d2a6'),
        'eoa': w3.eth.getCode('0x000018bbb8Df8de9e3eaf772dB1c4EEc228EF06c'),
        'uni_pairv2': w3.eth.getCode('0x06da0fd433C1A5d7a4faa01111c044910A184553'),
        'uni_pairv3': w3.eth.getCode('0x8f8EF111B67C04Eb1641f5ff19EE54Cda062f163'),
        'balancer': w3.eth.getCode('0xD5e10e8513E33a2867e20ddfc35Ee081CBA57769'),
        'aave_v0': w3.eth.getCode('0x7D2D3688Df45Ce7C552E19c27e007673da9204B8'),
        'aave_v1': w3.eth.getCode('0xfC1E690f61EFd961294b3e1Ce3313fBD8aa4f85d'),
        'aave_v2': w3.eth.getCode('0x8dAE6Cb04688C62d939ed9B68d32Bc62e49970b1'),
        'aave_debt_v2': w3.eth.getCode('0xD939F7430dC8D5a427f156dE1012A56C18AcB6Aa')
    }
