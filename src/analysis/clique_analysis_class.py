...
class CliqueAnalysis:
    ...
    def _calculate_internal_influence(self):
        ...
        internal_influence_pval = t_test(normalised_pct_supply_internal, normalised_pct_supply_internalC, alternative='greater')
    ...
    def _calculate_external_influence(self):
        ...
        external_influence_pval = t_test(normalised_pct_supply_external, normalised_pct_supply_externalC, alternative='greater')
    ...
    def _calculate_wealth_clique(self):
        ...
        total_wealth_pval = t_test(self.sub_df['value_usd'], self.sub_df_control['value_usd'], alternative='greater')
    ...
    def _calculate_gini_wealth_clique(self):
        ...
        gini_wealth_clique_pval = one_tailed_gini_t_test(self.sub_df['value_usd'], self.sub_df_control['value_usd'], alpha=0.05, direction="lower")
    ...
    def _calculate_median_wealth_level(self):
        ...
        median_wealth_level_clique_pval = median_t_test(self.sub_df.groupby('address')['value_usd'].sum(), self.sub_df_control.groupby('address')['value_usd'].sum(), alternative='greater')
    ...
    def _calculate_median_no_assets(self):
        ...
        median_no_assets_clique_pval = median_t_test(self.sub_df.groupby('address')['token_address'].count(), self.sub_df_control.groupby('address')['token_address'].count(), alternative='greater')
    ...
    def _calculate_max_influence_label(self):
        max_influence_label = self.sub_df.groupby(['label'])['pct_supply'].sum().idxmax()
        max_influence_labelC = self.sub_df_control.groupby(['label'])['pct_supply'].sum().idxmax()

        max_influence_label_value = self.sub_df.groupby(['label'])['pct_supply'].sum().max() / self.df.token_address.nunique()
        max_influence_label_valueC = self.sub_df_control.groupby(['label'])['pct_supply'].sum().max() / self.df.token_address.nunique()

        sample = self.sub_df[self.sub_df.label == max_influence_label].pct_supply
        control = self.sub_df_control[self.sub_df_control.label == max_influence_label].pct_supply
