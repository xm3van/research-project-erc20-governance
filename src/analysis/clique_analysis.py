...
class CliqueAnalysis:
    ...
    def _calculate_total_influence(self):
        ...
        gini_total_influence_pval = t_test(normalised_pct_supply, normalised_pct_supplyC, alternative="lower")
    ...
    def _calculate_internal_influence(self):
        ...
        gini_internal_influence_pval = t_test(normalised_pct_supply_internal, normalised_pct_supply_internalC, alternative="lower")
    ...
    def _calculate_external_influence(self):
        ...
        gini_external_influence_pval = t_test(normalised_pct_supply_external, normalised_pct_supply_externalC, alternative="lower")
    ...
    def _calculate_gini_wealth_clique(self):
        ...
        gini_wealth_clique_pval =t_test(self.sub_df['value_usd'], self.sub_df_control['value_usd'], alternative="lower")
    ...
    def _calculate_median_wealth_level(self):
        ...
        median_wealth_level_clique_pval = t_test(self.sub_df.groupby('address')['value_usd'].sum(), self.sub_df_control.groupby('address')['value_usd'].sum(), alternative='greater')
    ...
    def _calculate_median_no_assets(self):
        ...
        median_no_assets_clique_pval = t_test(self.sub_df.groupby('address')['token_address'].count(), self.sub_df_control.groupby('address')['token_address'].count(), alternative='greater')
